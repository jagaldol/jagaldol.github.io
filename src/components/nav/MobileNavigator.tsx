...
export default function MobileNavigator({ toggleNav, isNavOpen }: { toggleNav: () => void; isNavOpen: boolean }) {
  return (
    <button type="button" aria-label="메뉴" onClick={toggleNav} className="relative mr-5 h-6 p-1 z-50">
      {isNavOpen ? (
        <div
